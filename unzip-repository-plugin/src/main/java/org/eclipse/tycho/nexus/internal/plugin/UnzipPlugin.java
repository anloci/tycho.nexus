...
public class UnzipPlugin extends PluginIdentity {
     ...
     */
    @NonNls
    public static final String ID_PREFIX = "unzip";

    /**
     * Expected groupId for plugin artifact.
     */
    @NonNls
    public static final String GROUP_ID = "org.eclipse.tycho.nexus";

    /**
     * Expected artifactId for plugin artifact.
     */
    @NonNls
    public static final String ARTIFACT_ID = "unzip-repository-plugin";
